...
class AlertManager {
    ...
    func showAlert(type: AlertType, from controller: UIViewController, completion: @escaping (String?) -> Void) {
        switch type {
        case .folder:
            showFolderCreationAlert(from: controller, completionHandler: completion)
        case .file:
            showFileCreationAlert(from: controller, completionHandler: completion)
        }
    }
    
    func failedLogin(from controller: UIViewController, title: String, message: String?) {
    ...
    func showFileContent(from controller: UIViewController, at url: URL) {
    ...
    func showTextInsideFileAlert(from controller: UIViewController, at url: URL, message: String?, completionHandler: @escaping (Data?) -> Void) {
        let alertController = UIAlertController(title: url.lastPathComponent,
    ...
    func showFolderCreationAlert(from controller: UIViewController, completionHandler: @escaping (String?) -> Void) {
    ...
    func showFileCreationAlert(from controller: UIViewController, completionHandler: @escaping (String?) -> Void) {
